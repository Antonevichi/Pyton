...
# Условие 1. Человек против человека.

# Создайте программу для игры с конфетами человек против человека.
# Осталось описать последний ход условия, когда конфет не останется на столе
# продумать так чтобы не смог взять больше, чем есть
